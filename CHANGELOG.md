...
- What does not fit steps down a list, not a chain: the year goes, then the seconds with the date kept, then the date with the seconds back, then the seconds — so a terminal too short for two lines still shows `HH MM SS`.
- The R, G and B sliders wear their channel's colour at its value.
