...
- The board goes on ticking under the PIN prompt, dimmed; the prompt is 48 columns with a row of air above and below, and the dots grow out from its middle.
