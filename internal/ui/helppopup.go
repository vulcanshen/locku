...
// helpContent is the whole vocabulary (ux.md §A.2 and the appendix). The
...
var helpContent = []helpEntry{
	...
	{"?", "this help"},
	{"", "Global"},
	{"P", "preview: the lock with the active saver — on a saver's [2], that saver — drafts included; unlock to come back"},
